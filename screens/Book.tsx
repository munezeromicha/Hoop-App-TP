import { StyleSheet, Text, View, Image, TouchableOpacity,ScrollView, PanResponder, Animated  } from "react-native";
...
const Book: React.FC<BookScreenProps> = ({ navigation }) => {
  return (
    <View style={styles.BookBlock}>
      ...
      >
        <Text style={{ fontSize: 32, color: "#2D2D2D", width: 165 }}>
          Add Insurance?
        </Text>
      ...
      >
        <View>
          <Text style={{ fontSize: 24, color: "#2D2D2D", fontWeight: "bold" }}>
            $35,00
          </Text>
        </View>
